...
_C.MODEL.VMAMBA2.SIMPLE_DOWNSAMPLE = True
_C.MODEL.VMAMBA2.SIMPLE_PATCH_EMBED = True
_C.MODEL.VMAMBA2.SSD_EXPANSION = 2
_C.MODEL.VMAMBA2.SSD_NGROUPS = 1
_C.MODEL.VMAMBA2.SSD_CHUNK_SIZE = 256
_C.MODEL.VMAMBA2.LINEAR_ATTN_DUALITY = False
_C.MODEL.VMAMBA2.ATTN_TYPES = ['mamba2'] * 4
_C.MODEL.VMAMBA2.LEPE = False
_C.MODEL.VMAMBA2.BIDIRECTION = False
_C.MODEL.VMAMBA2.D_STATE = 64
_C.MODEL.VMAMBA2.SSD_POSITIVE_DA = False
# -----------------------------------------------------------------------------
# Training settings
# -----------------------------------------------------------------------------
_C.TRAIN = CN()
